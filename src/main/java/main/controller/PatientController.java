    ...
    public void chooseListOperations(List<Patient> patients){
        ...
        while (true) {
            ...
            switch (menu) {
                ...
                case 4 ->{
                    if (patients != null) {
                        view.printer("The list of patients: ");
                        view.showPatient(service.listOfPatientsByCurrentYearVisitCount(patients));
                    }
                }
                case 5 ->{
                    if (patients != null) {
                        view.printer("Enter the name of the patient: ");
                        String name = scanner.nextLine();
                        view.printerIndividualInfo("The medical record number of the person is: ", service.findPatientByName(patients, name));
                    }
                }
                case 6 -> {
                    break exitLabel;
